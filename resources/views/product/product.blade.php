                ...
                <div class="padding-section-small">
                    ...
                    <div class="product-country_component">
                        <div class="product-country_item">
                            ...
                            <h3 class="heading-style-h6 is-product"><a href="/products/crem-mobile-banking" class="link-product">Mobile Banking</a></h3>
                        ...
                        <div class="product-country_item">
                            ...
                            <div class="padding-bottom padding-xxsmall"></div>
                            <h3 class="heading-style-h6 is-product"><a href="/products/crem-visa-card" class="link-product">Cartes Visa prépayées</a></h3>
                            <div class="padding-bottom padding-xsmall"></div>
                        ...
                        <div class="product-country_item">
                            ...
                            <div class="padding-bottom padding-xxsmall"></div>
                            <h3 class="heading-style-h6 is-product"><a href="" class="link-product">Comptes d'Epargnes</a></h3>
                            <div class="padding-bottom padding-xsmall"></div>
                        ...
                        <div class="product-country_item">
                            ...
                            <div class="padding-bottom padding-xxsmall"></div>
                            <h3 class="heading-style-h6 is-product"><a href="" class="link-product">Ouverture de comptes</a></h3>
                            <div class="padding-bottom padding-xsmall"></div>
                        ...
                        <div class="product-country_item">
                            ...
                            <div class="padding-bottom padding-xxsmall"></div>
                            <h3 class="heading-style-h6 is-product"><a href="" class="link-product">CREMIN-CAM money</a></h3>
                            <div class="padding-bottom padding-xsmall"></div>
                            <p class="text-size-small text-color-slategrey">Par le biais de notre partenaire <b>CAMPOST</b>,
                        ...
                        <div class="product-country_item">
                            ...
                            <div class="padding-bottom padding-xxsmall"></div>
                            <h3 class="heading-style-h6 is-product"><a href="" class="link-product">Comptes Salaires</a></h3>
                            <div class="padding-bottom padding-xsmall"></div>
                ...
                <div class="padding-section-small">
                    <div class="products_clients-component">
                        <div class="products_client-content">
                            ...
                            <p class="text-color-white text-size-large">Toutes vos opérations bancaires sur votre mobile. Simplifiez votre quotidien bancaire avec notre appli mobile, accédez à vos services bancaires en un clin d'œil.</p>
                            <div class="padding-bottom padding-small"></div>
                            <img
                                src="{{ asset("images/products/logo-solo.png") }}"
                                loading="lazy" alt="Solo logo" class="products_client-logo" />
                            <div class="row">
                                <div class="col-6">
                                    <a href="https://play.google.com/apps/test/com.cagecfi.pmobile_cremincam_client/27" class="btn-solo-product">
                        ...
                        <div class="products_client-image-wrapper"><img
                                src="{{ asset("images/products/app-mob.png") }}"
                                loading="lazy"
